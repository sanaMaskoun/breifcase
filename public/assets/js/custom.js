  ...
  if (infoTeoaset !== null) {
    infoTeoaset.on("click", function () {
      ...
      if (thisId === "toaster-info") {
        toastr.info("Welcome to breifcase", " Info message");
      } else if (thisId === "toaster-success") {
        toastr.success("Welcome to breifcase", "Success message");
      } else if (thisId === "toaster-warning") {
        toastr.warning("Welcome to breifcase", "Warning message");
      } else if (thisId === "toaster-danger") {
        toastr.error("Welcome to breifcase", "Danger message");
      }
    });
  }
