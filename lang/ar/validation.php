...
return [
    ...
    */
    ...
    'digits_between' => 'يجب أن يكون الحقل  بين رقمين :min و:max.',
    ...
    'max' => [
        'array' => 'يجب ألا يحتوي حقل  على أكثر من :max من العناصر.',
        'file' => 'يجب ألا يكون الحقل  أكبر من :max كيلو بايت.',
        'numeric' => 'يجب ألا يكون الحقل   أكبر من:max.',
         'string' => 'يجب ألا يزيد الحقل  عن :max الأحرف.',
    ],
    ...
    'numeric' => '  هذا الحقل يجب أن يكون ارقام',
    'password' => [
