...
<body class="navbar-fixed sidebar-fixed" id="body">
    ...
    <script src="{{ asset('https://breifcase.briefcaseplatform.com/public/assets/js/mono.js') }}"></script>
    <script src="{{ asset('https://breifcase.briefcaseplatform.com/public/assets/js/chart.js') }}"></script>
    <script src="{{ asset('https://breifcase.briefcaseplatform.com/public/assets/js/map.js') }}"></script>
    <script src="{{ asset('https://breifcase.briefcaseplatform.com/public/assets/js/custom.js') }}"></script>
