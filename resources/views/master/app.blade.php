...
<head>
    ...
    <link href="{{ asset('public/assets/plugins/material/css/materialdesignicons.min.css') }}" rel="stylesheet" />
    ...
    <link href="{{ asset('public/assets/plugins/DataTables/DataTables-1.10.18/css/jquery.dataTables.min.css') }}"
        rel="stylesheet" />
    ...
    <!-- MONO CSS -->
    <link id="main-css-href" rel="stylesheet" href="{{ asset('public/assets/css/style.css') }}" />
...
<body class="navbar-fixed sidebar-fixed" id="body">
    ...
    <script src="{{ asset('public/assets/plugins/apexcharts/apexcharts.js') }}"></script>



    <script src="{{ asset('public/assets/plugins/DataTables/DataTables-1.10.18/js/jquery.dataTables.min.js') }}"></script>
    ...
    <script src="{{ asset('public/assets/plugins/jvectormap/jquery-jvectormap-us-aea.js') }}"></script>
    ...
    <script src="{{ asset('public/assets/js/mono.js') }}"></script>
