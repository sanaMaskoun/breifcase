        ...
        <div class="content">
            ...
            <div class="list-document-dashboard">
                ...
                <div class=" col-md-4 mt-5">
                    <img alt="" src="{{ $suggestion->user->getFirstMediaUrl('profile') }}" class="img-user-suggestion-details">
                ...
                <div class=" col-md-8  mt-5  body-suggestion">
                    ...
                    <span class="d-flex justify-content-end">{{ $suggestion->created_at->format('Y/m/d') }}</span>
                </div>
