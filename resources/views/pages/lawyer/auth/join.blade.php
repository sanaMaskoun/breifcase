        ...
        <form method="POST" action="{{ route('store_join_lawyer') }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="form-group-sign col-md-6">
                    ...
                    <input type="text" class="form-control-sign input-inline" id="name" value="{{ old('name') }}"
                        name="name" />
                    @error('name')
            ...
            <div class="row">
                <div class="form-group-sign col-md-6 d-b">
            ...
            <div class="row">
                <div class="form-group-sign col-md-6">
                    ...
                    <input type="text" class="form-control form-control-sign input-inline" id="birth"
                        value="{{ old('birth') }}" name="birth" />
                    @error('birth')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="row">
                <div class="form-group-sign col-md-6 email-1">
            ...
            <div class="row">
                <div class="form-group-sign col-md-6 mobile-1">
            ...
            <div class="row">
                <div class="form-group-sign col-md-6 land-1">
                    ...
                    <select class="form-control-sign" id="city" name="city">
                        ...
                        <option value="1" class="saudi-city" {{ old('city') == 1 ? 'selected' : '' }}>
                            @lang('EnumFile.riyadh')</option>
                        <option value="2" class="saudi-city" {{ old('city') == 2 ? 'selected' : '' }}>
                            @lang('EnumFile.mecca')</option>
                        <option value="3" class="saudi-city" {{ old('city') == 3 ? 'selected' : '' }}>
                            @lang('EnumFile.medina')</option>
                        <option value="4" class="saudi-city" {{ old('city') == 4 ? 'selected' : '' }}>
                            @lang('EnumFile.dammam')</option>
                        <option value="5" class="saudi-city" {{ old('city') == 5 ? 'selected' : '' }}>
                            @lang('EnumFile.jeddah')</option>
                        <option value="6" class="saudi-city" {{ old('city') == 6 ? 'selected' : '' }}>
                            @lang('EnumFile.khobar')</option>
                        <option value="7" class="saudi-city" {{ old('city') == 7 ? 'selected' : '' }}>
                            @lang('EnumFile.abha')</option>
                        <option value="8" class="saudi-city" {{ old('city') == 8 ? 'selected' : '' }}>
                            @lang('EnumFile.tabuk')</option>
                        <option value="9" class="saudi-city" {{ old('city') == 9 ? 'selected' : '' }}>
                            @lang('EnumFile.hail')</option>
                        <option value="10" class="saudi-city" {{ old('city') == 10 ? 'selected' : '' }}>
                            @lang('EnumFile.jazan')</option>
                        <option value="11" class="saudi-city" {{ old('city') == 11 ? 'selected' : '' }}>
                            @lang('EnumFile.najran')</option>
                        <option value="12" class="saudi-city" {{ old('city') == 12 ? 'selected' : '' }}>
                            @lang('EnumFile.baha')</option>
                        <option value="13" class="saudi-city" {{ old('city') == 13 ? 'selected' : '' }}>
                            @lang('EnumFile.al_jouf')</option>

                        <option value="100" class="uae-city" {{ old('city') == 100 ? 'selected' : '' }}>
                            @lang('EnumFile.dubai')</option>
                        <option value="101" class="uae-city" {{ old('city') == 101 ? 'selected' : '' }}>
                            @lang('EnumFile.abu_dhabi')</option>
                        <option value="102" class="uae-city" {{ old('city') == 102 ? 'selected' : '' }}>
                            @lang('EnumFile.ajman')</option>
                        <option value="103" class="uae-city" {{ old('city') == 103 ? 'selected' : '' }}>
                            @lang('EnumFile.rak')</option>
                        <option value="104" class="uae-city" {{ old('city') == 104 ? 'selected' : '' }}>
                            @lang('EnumFile.fujairah')</option>
                        <option value="105" class="uae-city" {{ old('city') == 105 ? 'selected' : '' }}>
                            @lang('EnumFile.um_alq')</option>
                        <option value="106" class="uae-city" {{ old('city') == 106 ? 'selected' : '' }}>
                            @lang('EnumFile.sharjah')</option>
