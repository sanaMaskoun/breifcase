                ...
                <div class="row align-items-center">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">@lang('pages.edit_general_chat')</h3>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card comman-shadow">
                        <div class="card-body">
                            <form method="POST" action="{{ route('update_general_chat', $group->id) }}">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control" type="text" name="name"
                                                value="{{ $group->name }}" placeholder=@lang('pages.enter_name')>
                                                @if ($errors->has('name'))
                                                <span
                                            ...
                                            <div class="follow-btn-group">
                                                @foreach ($members as $member)
                                                    <label style="padding-left: 10px">
                                                        <input type="checkbox" name="members[]"  class="member-checkbox" value="{{ $member->id }}"
                                                            {{ !is_null($group->users) && in_array($member->id, $group->users->pluck('id')->toArray()) ? 'checked' : '' }} />
