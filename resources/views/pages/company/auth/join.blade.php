...
@section('content')
    <div class="container box-sign-2 mt-5 col-12">
        <form method="POST" action="{{ route('store_join_translation_company') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-check-1">
                        ...
                        @foreach ($languages as $language)
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="language_{{ $language->id }}"
            ...
            <div class="row">
                <div class="form-group-sign file-upload col-md-12 ">
                    <div class="form-check chek">
                        <label class="form-check-label avv-company" for="availability">
